...
<div id="container">
	...
	<form action="<?php echo base_url(); ?>index.php/login/login_verification" method="post" style="padding-left: 30%;">
		...
		name: <input id="login" class="txt" type="text" name="l_password"><br/><br/>
		address: <input id="login" class="txt" type="text" name="l_password"><br/><br/>
		city: <input id="login" class="txt" type="text" name="l_password"><br/><br/>
