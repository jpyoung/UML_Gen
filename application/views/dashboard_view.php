...
<div id="belowNavWrapper">
	<div id="wrapper">
		<div id="sidebar">
			...
			<div class="navi">
				<ul class="main-side_nav">
					<li>
						<a href="<?php echo base_url(); ?>index.php/welcome" class="light">
							<div class="ico" style="background-color: white;">
								<img class="left_bar_image" width="15px" height="15px" src="<?php echo base_url(); ?>assets/img/glyphicons/png/glyphicons_020_home.png">
								</div>
							Dashboard
					...
					<li>
						<a href="<?php echo base_url(); ?>index.php/welcome/goto_user_management_page" class="light">
							<div class="ico" style="background-color: white;">
								<img class="left_bar_image"width="15px" height="15px" src="<?php echo base_url(); ?>assets/img/glyphicons/png/glyphicons_043_group.png">
							</div>
							User Management
					...
					<li>
						<a href="<?php echo base_url(); ?>index.php/welcome/goto_user_preferences" class="light">
							<div class="ico" style="background-color: white;">
