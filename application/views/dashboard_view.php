				...
				<ul class="main-side_nav">
					<li>
						<a href="dashboard.html" class="light">
							<div class="ico" style="background-color: white;">
								<img class="left_bar_image" width="14px" height="14px" src="<?php echo base_url(); ?>assets/img/glyphicons/png/glyphicons_020_home.png">
								</div>
							Dashboard
					...
					<li>
						<a href="forms.html" class="light">
							<div class="ico" style="background-color: white;">
								<img class="left_bar_image"width="14px" height="14px" src="<?php echo base_url(); ?>assets/img/glyphicons/png/glyphicons_043_group.png">
							</div>
							User Management
					...
					<li>
						<a href="<?php echo base_url(); ?>index.php/welcome/goto_user_management_page" class="light">
							<div class="ico" style="background-color: white;">
								<img class="left_bar_image"width="14px" height="14px" src="<?php echo base_url(); ?>assets/img/glyphicons/png/glyphicons_029_notes_2.png">
							</div>
							User Preferences
							<span class="label label-info">1</span>
						</a>
